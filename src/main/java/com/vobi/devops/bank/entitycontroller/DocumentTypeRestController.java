...
public class DocumentTypeRestController {
    ...
    public ResponseEntity<?> findById(@PathVariable("dotyId")
    Integer dotyId) throws Exception {
        log.debug("Request to findById() DocumentType");

        Optional<DocumentType> optional = documentTypeService.findById(dotyId);

        DocumentType documentType = (optional.isPresent() == true)
            ? optional.get() : null;

        return ResponseEntity.ok()
                             .body(documentTypeMapper.documentTypeToDocumentTypeDTO(
                documentType));
    }
    ...
    public ResponseEntity<?> findAll() throws Exception {
        ...
        return ResponseEntity.ok()
                             .body(documentTypeMapper.listDocumentTypeToListDocumentTypeDTO(
    ...
    public ResponseEntity<?> save(
        @Valid
    @RequestBody
    DocumentTypeDTO documentTypeDTO) throws Exception {
    ...
    public ResponseEntity<?> delete(@PathVariable("dotyId")
    Integer dotyId) throws Exception {
